...
enum PlanetService {
    static let all: [Planet] = [
        Planet(
            image: "sun", color: 0xFFCC00, name: "Soleil",
        ...
        Planet(
            image: "mercure", color: 0x7C7C7C, name: "Mercure",
        ...
        Planet(
            image: "venus", color: 0xFF9500, name: "Venus",
        ...
        Planet(
            image: "earth", color: 0x0A84FF, name: "Terre",
        ...
        Planet(
            image: "mars", color: 0xFF3B30, name: "Mars",
        ...
        Planet(
            image: "jupiter", color: 0xA2845E, name: "Jupiter",
        ...
        Planet(
            image: "saturn", color: 0x34C759, name: "Saturne",
        ...
        Planet(
            image: "uranus", color: 0xAF52DE, name: "Uranus",
        ...
        Planet(
            image: "neptune", color: 0x32ADE6, name: "Neptune",
