...
let rocketShips: [RocketShip] = [
    RocketShip(
        ...
        astronauts: [astro_Grissom, astro_White, astro_Chaffee]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Schirra, astro_Eisele, astro_Cunningham]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Borman, astro_Lovell, astro_Anders]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_McDivitt, astro_Scott, astro_Schweickart]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Young, astro_Crippen]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Hopkins, astro_Glover, astro_Walker]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Kimbrough, astro_McArthur, astro_Pesquet]
    ),
    ...
    RocketShip(
        ...
        astronauts: [astro_Armstrong, astro_Aldrin, astro_Collins]
    ),
    ...
    RocketShip(
        name: "STS-1",
        image: "navette",
        description: "STS-1 a marqué le début d'une ère nouvelle avec le premier vol orbital de la navette spatiale Columbia. Le 12 avril 1981, John Young et Robert Crippen ont décollé pour tester ce véhicule révolutionnaire et réutilisable. Contrairement aux capsules précédentes, Columbia a atterri comme un planeur sur une piste californienne après 54 heures de vol. Cette mission a prouvé la viabilité du concept de navette pour le transport de charges lourdes et le déployement de satellites, transformant radicalement l'accès à l'espace. Elle reste un pilier de l'histoire technologique de l'exploration spatiale.",
        astronauts: [astro_Young, astro_Crippen]
    )
]
